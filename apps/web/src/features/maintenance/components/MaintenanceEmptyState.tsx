...
export function MaintenanceEmptyState({
  ...
  description = "There are currently no maintenance records matching your criteria.",
    ...
    <div className="flex min-h-[360px] flex-col items-center justify-center px-6 py-12 text-center">
      ...
      {onAction && (
        <button
          type="button"
          onClick={onAction}
          className="mt-5 flex h-9 items-center gap-1.5 rounded-lg bg-[#1677FF] px-4 text-xs font-semibold text-white shadow-sm transition hover:bg-[#1264D8]"
        >
